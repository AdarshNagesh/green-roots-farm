...
const WHATSAPP = process.env.NEXT_PUBLIC_CONTACT_WHATSAPP || PHONE
...
export function FloatingWhatsApp({ message = "Hi! I have a question about your farm produce." }) {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" title="Chat with us on WhatsApp"
      style={{ position:'fixed', bottom:24, right:24, zIndex:800,
        width:56, height:56, borderRadius:'50%', background:'#25D366', color:'#fff',
        display:'flex', alignItems:'center', justifyContent:'center',
        boxShadow:'0 4px 18px rgba(37,211,102,0.45)', textDecoration:'none', transition:'transform .2s, box-shadow .2s' }}
...
export function Footer() {
  ...
  return (
    <footer style={{ background:'var(--text)', color:'rgba(255,255,255,0.85)', marginTop:64, padding:'48px 20px 32px' }}>
      <div style={{ maxWidth:1120, margin:'0 auto' }}>
        <div style={{ display:'grid', gridTemplateColumns:'1.5fr 1fr 1fr', gap:40, marginBottom:40 }}>
          ...
          <div>
            <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
              ...
              <div style={{ ...serif, fontSize:20, fontWeight:700, color:'#fff' }}>Adarshini Organic Farm</div>
            </div>
          ...
          <div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
              {[{label:'🛒 Shop',href:'/'},{label:'📦 My Orders',href:'/orders'},{label:'📞 Contact Us',href:'#contact'}].map(l=>(
                <a key={l.href} href={l.href}
                  style={{ fontSize:13, color:'rgba(255,255,255,0.7)', textDecoration:'none', transition:'color .2s' }}
          ...
          <div id="contact">
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              {PHONE && (
                <a href={`tel:${PHONE}`} style={{ display:'flex', alignItems:'center', gap:10,
                  fontSize:13, color:'rgba(255,255,255,0.8)', textDecoration:'none' }}>
                  <span style={{ width:32, height:32, borderRadius:'50%', background:'rgba(255,255,255,0.1)',
              ...
              {EMAIL && (
                <a href={`mailto:${EMAIL}`} style={{ display:'flex', alignItems:'center', gap:10,
                  fontSize:13, color:'rgba(255,255,255,0.8)', textDecoration:'none' }}>
                  <span style={{ width:32, height:32, borderRadius:'50%', background:'rgba(255,255,255,0.1)',
                    display:'flex', alignItems:'center', justifyContent:'center', fontSize:15 }}>✉️</span>
                  <div>
              ...
              {(PHONE || WHATSAPP) && (
                <a href={waHref} target="_blank" rel="noopener noreferrer"
                  style={{ display:'flex', alignItems:'center', gap:10,
                    fontSize:13, color:'rgba(255,255,255,0.8)', textDecoration:'none' }}>
                  <span style={{ width:32, height:32, borderRadius:'50%', background:'#25D366',
                    display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ borderTop:'1px solid rgba(255,255,255,0.1)', paddingTop:20,
          ...
          <div style={{ fontSize:12, color:'rgba(255,255,255,0.35)' }}>
            © {new Date().getFullYear()} Adarshini Organic Farm. All rights reserved.
          </div>
          <div style={{ fontSize:12, color:'rgba(255,255,255,0.35)' }}>
